 ...
 *
 *      $Id: misc_seccode.php 34087 2013-10-09 03:19:37Z nemohou $
 */
	...
	if($_G['setting']['seccodestatus']) {
		...
		if($_G['setting']['seccodedata']['type'] == 2) {
			$message = '<span id="seccodeswf_'.$idhash.'"></span>'.(extension_loaded('ming') ? "<script type=\"text/javascript\" reload=\"1\">\n$('seccodeswf_$idhash').innerHTML='".lang('core', 'seccode_image'.$ani.'_tips')."' + AC_FL_RunContent(
				...
				'align', 'middle', 'menu', 'false', 'allowScriptAccess', 'never');\n</script>" :
				...
				'FlashVars', 'sFile=".rawurlencode("$_G[siteurl]misc.php?mod=seccode&update=$rand&idhash=$idhash")."', 'menu', 'false', 'allowScriptAccess', 'never', 'swLiveConnect', 'true', 'wmode', 'transparent');\n</script>");
